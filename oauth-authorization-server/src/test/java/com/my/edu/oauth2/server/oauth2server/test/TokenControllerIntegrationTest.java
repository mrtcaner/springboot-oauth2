package com.my.edu.oauth2.server.oauth2server.test;
...
import com.my.edu.oauth2.server.oauth2server.config.AuthorizationServerApplication;
import com.my.edu.oauth2.server.oauth2server.controller.TokenController;
